 ...
 * @author HP
 */
public class NewJFrameDAD extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("HAUI HOME PAGE");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã lớp", "Tên lớp", "Ngày bắt đầu", "Ngày kết thúc", "Số buổi học", "Số sinh viên"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewJFrameDAD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NewJFrameDAD().setVisible(true);
            }
        });
    }
